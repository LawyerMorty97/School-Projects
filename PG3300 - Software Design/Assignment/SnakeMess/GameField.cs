    ...
    class GameField
    {
        ...
        private void HandleInput()
        {
            if (Console.KeyAvailable)
            {
                ...
                else if (keyList.Key == ConsoleKey.UpArrow || keyList.Key == ConsoleKey.W && lastDirection != Direction.Down)
                {
                    Player.CurrentDirection = Direction.Up;
                }
                else if (keyList.Key == ConsoleKey.DownArrow || keyList.Key == ConsoleKey.S && lastDirection != Direction.Up)
                {
                   Player.CurrentDirection = Direction.Down;
                }
                else if (keyList.Key == ConsoleKey.LeftArrow || keyList.Key == ConsoleKey.A && lastDirection != Direction.Right)
                {
                    Player.CurrentDirection = Direction.Left;
                }
                else if (keyList.Key == ConsoleKey.RightArrow || keyList.Key == ConsoleKey.D && lastDirection != Direction.Left)
                {
